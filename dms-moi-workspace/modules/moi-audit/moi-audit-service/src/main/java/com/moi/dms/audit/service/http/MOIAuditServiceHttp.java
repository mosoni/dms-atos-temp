 ...
 * @see MOIAuditServiceSoap
 * @generated
 */
public class MOIAuditServiceHttp {
	...
	public static java.util.List<com.moi.dms.audit.model.MOIAudit>
		...
		try {
			MethodKey methodKey = new MethodKey(
				MOIAuditServiceUtil.class, "getMOIAuditByKeywords",
				_getMOIAuditByKeywordsParameterTypes0);
			...
			return (java.util.List<com.moi.dms.audit.model.MOIAudit>)returnObj;
		}
	...
	public static java.util.List<com.moi.dms.audit.model.MOIAudit>
		...
		try {
			MethodKey methodKey = new MethodKey(
				MOIAuditServiceUtil.class, "getMOIAuditBySearchCriteria",
				_getMOIAuditBySearchCriteriaParameterTypes1);
	...
	private static Log _log = LogFactoryUtil.getLog(MOIAuditServiceHttp.class);

	private static final Class<?>[] _getMOIAuditByKeywordsParameterTypes0 =
		new Class[] {
			String.class, int.class, int.class,
			com.liferay.portal.kernel.util.OrderByComparator.class
		};
	private static final Class<?>[]
		_getMOIAuditBySearchCriteriaParameterTypes1 = new Class[] {
