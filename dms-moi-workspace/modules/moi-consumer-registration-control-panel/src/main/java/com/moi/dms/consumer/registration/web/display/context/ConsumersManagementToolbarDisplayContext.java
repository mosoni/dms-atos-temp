package com.moi.dms.consumer.registration.web.display.context;
...
/**
 * Consumer Registration management toolbar display context.
 *
 ...
 */
public class ConsumersManagementToolbarDisplayContext
		extends BaseManagementToolbarDisplayContext {

	public ConsumersManagementToolbarDisplayContext(
		...
		return new CreationMenu() {
			{
				addDropdownItem(dropdownItem -> {
					dropdownItem.setHref(
							...
							MVCCommandNames.EDIT_CONSUMER, "redirect",
	...
	public String getDisplayStyle() {
		...
		if (Validator.isNull(displayStyle)) {
			displayStyle = _portalPreferences.getValue(
					DMSConsumerRegistrationPortletKeys.DMSConsumerRegistration,
	...
	public String getOrderByCol() {
		return ParamUtil.getString(request, "orderByCol", "consumerId");
	}
	...
	public String getSearchActionURL() {
		...
		searchURL.setProperty("mvcRenderCommandName",
				MVCCommandNames.VIEW_CONSUMERS);
