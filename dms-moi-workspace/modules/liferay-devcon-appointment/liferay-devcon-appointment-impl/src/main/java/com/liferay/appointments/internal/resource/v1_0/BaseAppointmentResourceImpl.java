...
public abstract class BaseAppointmentResourceImpl
	implements AppointmentResource, EntityModelResource,
			   VulcanBatchEngineTaskItemDelegate<Appointment> {
	 ...
	 * Invoke this method with the command line:
	 *
	 * curl -X 'POST' 'http://localhost:8080/o/appointments/v1.0/sites/{siteId}/appointments/batch'  -u 'test@liferay.com:test'
	 */
	@Override
	...
	@Path("/sites/{siteId}/appointments/batch")
	...
	public Response postSiteAppointmentBatch(
		...
		return responseBuilder.entity(
			vulcanBatchEngineImportTaskResource.postImportTask(
				Appointment.class.getName(), callbackURL, null, object)
		).build();
	}
	 ...
	 * Invoke this method with the command line:
	 *
	 * curl -X 'POST' 'http://localhost:8080/o/appointments/v1.0/sites/{siteId}/appointments/document'  -u 'test@liferay.com:test'
	 */
	@Override
	...
	@POST
	@Parameters(value = {@Parameter(in = ParameterIn.PATH, name = "siteId")})
	@Path("/sites/{siteId}/appointments/document")
	@Produces({"application/json", "application/xml"})
	@Tags(value = {@Tag(name = "Appointment")})
	...
	public void create(
			java.util.Collection<Appointment> appointments,
			Map<String, Serializable> parameters)
		throws Exception {

		for (Appointment appointment : appointments) {
			postSiteAppointment(
				Long.valueOf((String)parameters.get("siteId")), appointment);
		}
	}
	...
	@Override
	public Page<Appointment> read(
			Filter filter, Pagination pagination, Sort[] sorts,
			Map<String, Serializable> parameters, String search)
		throws Exception {

		return getSiteAppointmentsPage((Long)parameters.get("siteId"));
	}
