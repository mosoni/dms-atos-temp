package com.liferay.appointments.dto.v1_0;
 ...
 */
@Generated("")
@GraphQLName("SiteDocument")
@JsonFilter("Liferay.Vulcan")
@XmlRootElement(name = "SiteDocument")
public class SiteDocument {
	...
	public boolean equals(Object object) {
		...
		if (!(object instanceof SiteDocument)) {
			return false;
		}

		SiteDocument siteDocument = (SiteDocument)object;

		return Objects.equals(toString(), siteDocument.toString());
	}
	...
	@Schema(
		defaultValue = "com.liferay.appointments.dto.v1_0.SiteDocument",
		name = "x-class-name"
	)
