...
/**
 * Provides the local service interface for MOITraceRequest. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see MOITraceRequestLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface MOITraceRequestLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.moi.dms.trace.request.service.impl.MOITraceRequestLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the moi trace request local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link MOITraceRequestLocalServiceUtil} if injection and service tracking are not available.
	 */
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<MOITraceRequest> getMOITraceRequestByRequestId(
