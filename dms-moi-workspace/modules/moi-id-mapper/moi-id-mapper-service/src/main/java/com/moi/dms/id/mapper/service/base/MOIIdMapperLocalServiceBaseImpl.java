...
import com.moi.dms.id.mapper.service.MOIIdMapperLocalService;
...
/**
 * Provides the base implementation for the moi ID mapper local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.moi.dms.id.mapper.service.impl.MOIIdMapperLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.moi.dms.id.mapper.service.impl.MOIIdMapperLocalServiceImpl
 * @generated
 */
public abstract class MOIIdMapperLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, IdentifiableOSGiService, MOIIdMapperLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>MOIIdMapperLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.moi.dms.id.mapper.service.MOIIdMapperLocalServiceUtil</code>.
	 */
	...
	public MOIIdMapper addMOIIdMapper(MOIIdMapper moiIdMapper) {
		...
		return moiIdMapperPersistence.update(moiIdMapper);
	}
	...
	public MOIIdMapper createMOIIdMapper(long mapperId) {
		return moiIdMapperPersistence.create(mapperId);
	}
	...
	public MOIIdMapper deleteMOIIdMapper(long mapperId) throws PortalException {
		return moiIdMapperPersistence.remove(mapperId);
	}
	...
	public MOIIdMapper deleteMOIIdMapper(MOIIdMapper moiIdMapper) {
		return moiIdMapperPersistence.remove(moiIdMapper);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			MOIIdMapper.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return moiIdMapperPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return moiIdMapperPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return moiIdMapperPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return moiIdMapperPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public MOIIdMapper fetchMOIIdMapper(long mapperId) {
		return moiIdMapperPersistence.fetchByPrimaryKey(mapperId);
	}
	...
	public MOIIdMapper getMOIIdMapper(long mapperId) throws PortalException {
		return moiIdMapperPersistence.findByPrimaryKey(mapperId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(moiIdMapperLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(MOIIdMapper.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("mapperId");
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(MOIIdMapper.class);

		indexableActionableDynamicQuery.setPrimaryKeyPropertyName("mapperId");
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return moiIdMapperLocalService.deleteMOIIdMapper(
			(MOIIdMapper)persistedModel);
	}

	public BasePersistence<MOIIdMapper> getBasePersistence() {
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return moiIdMapperPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<MOIIdMapper> getMOIIdMappers(int start, int end) {
		return moiIdMapperPersistence.findAll(start, end);
	}
	...
	public int getMOIIdMappersCount() {
		return moiIdMapperPersistence.countAll();
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			MOIIdMapperLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		moiIdMapperLocalService = (MOIIdMapperLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return MOIIdMapperLocalService.class.getName();
	}
	...
	protected MOIIdMapperLocalService moiIdMapperLocalService;
