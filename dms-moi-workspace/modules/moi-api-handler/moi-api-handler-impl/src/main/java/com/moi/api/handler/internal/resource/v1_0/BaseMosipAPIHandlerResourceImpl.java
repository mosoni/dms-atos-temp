...
@Generated("")
@Path("/v1.0")
public abstract class BaseMosipAPIHandlerResourceImpl
	implements MosipAPIHandlerResource, EntityModelResource,
			   VulcanBatchEngineTaskItemDelegate<MosipAPIHandler> {

	/**
	 * Invoke this method with the command line:
	 *
	 * curl -X 'POST' 'http://localhost:8080/o/moi-api-handler/v1.0/uploadDocument'  -u 'test@liferay.com:test'
	 */
	@Override
	...
	@Parameters(
		value = {
			...
			@Parameter(in = ParameterIn.QUERY, name = "IdentifierNumber"),
			@Parameter(in = ParameterIn.QUERY, name = "Metadata"),
			@Parameter(in = ParameterIn.QUERY, name = "PreviousModuleType"),
			@Parameter(in = ParameterIn.QUERY, name = "PreviousIdentifier")
		}
	)
	@Path("/uploadDocument")
	...
	public Page<DocumentResult> uploadMosipDocument(
			...
			@Parameter(hidden = true) @QueryParam("DocumentType") String
				DocumentType,
			@Parameter(hidden = true) @QueryParam("IdentifierNumber") String
				IdentifierNumber,
			@Parameter(hidden = true) @QueryParam("Metadata") String Metadata,
			@Parameter(hidden = true) @QueryParam("PreviousModuleType") String
				PreviousModuleType,
			@Parameter(hidden = true) @QueryParam("PreviousIdentifier") String
				PreviousIdentifier,
	 ...
	 * Invoke this method with the command line:
	 *
	 * curl -X 'POST' 'http://localhost:8080/o/moi-api-handler/v1.0/updateDocument'  -u 'test@liferay.com:test'
	 */
	@Override
	@Consumes("multipart/form-data")
	@POST
	...
	@Override
	public Page<MosipAPIHandler> read(
