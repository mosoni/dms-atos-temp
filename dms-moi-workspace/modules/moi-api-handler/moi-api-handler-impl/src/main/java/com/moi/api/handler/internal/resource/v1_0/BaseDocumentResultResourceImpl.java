...
@Generated("")
@Path("/v1.0")
public abstract class BaseDocumentResultResourceImpl
	implements DocumentResultResource, EntityModelResource,
			   VulcanBatchEngineTaskItemDelegate<DocumentResult> {
	...
	public void create(
			java.util.Collection<DocumentResult> documentResults,
	...
	@Override
	public Page<DocumentResult> read(
