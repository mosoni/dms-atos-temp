...
@Generated("")
@Path("/v1.0")
public abstract class BaseJiraAPIHandlerResourceImpl
	implements JiraAPIHandlerResource, EntityModelResource,
			   VulcanBatchEngineTaskItemDelegate<JiraAPIHandler> {
	...
	@Tags(value = {@Tag(name = "JiraAPIHandler")})
	...
	public void create(
			java.util.Collection<JiraAPIHandler> jiraAPIHandlers,
	...
	@Override
	public Page<JiraAPIHandler> read(
