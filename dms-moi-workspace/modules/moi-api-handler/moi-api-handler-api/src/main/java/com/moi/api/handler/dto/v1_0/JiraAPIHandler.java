 ...
 */
@Generated("")
@GraphQLName("JiraAPIHandler")
@JsonFilter("Liferay.Vulcan")
@XmlRootElement(name = "JiraAPIHandler")
public class JiraAPIHandler {

	public static JiraAPIHandler toDTO(String json) {
		return ObjectMapperUtil.readValue(JiraAPIHandler.class, json);
	}
	...
	@Schema(
		defaultValue = "com.moi.api.handler.dto.v1_0.JiraAPIHandler",
		name = "x-class-name"
	)
