 ...
 */
@Generated("")
@GraphQLName("MosipAPIHandler")
@JsonFilter("Liferay.Vulcan")
@XmlRootElement(name = "MosipAPIHandler")
public class MosipAPIHandler {

	public static MosipAPIHandler toDTO(String json) {
		return ObjectMapperUtil.readValue(MosipAPIHandler.class, json);
	}
	...
	@Schema(
		defaultValue = "com.moi.api.handler.dto.v1_0.MosipAPIHandler",
		name = "x-class-name"
	)
