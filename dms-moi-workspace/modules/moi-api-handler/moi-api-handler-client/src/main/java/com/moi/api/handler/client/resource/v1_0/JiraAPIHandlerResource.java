 ...
 */
@Generated("")
public interface JiraAPIHandlerResource {

	public static Builder builder() {
		return new Builder();
	}

	public Page<DocumentResult> uploadJiraDocument(
			String consumerCode, String ticketNumber, String documentTitle,
			String metadata, JiraAPIHandler jiraAPIHandler,
	...
	public static class Builder {
		...
		public JiraAPIHandlerResource build() {
			return new JiraAPIHandlerResourceImpl(this);
		}
	...
	public static class JiraAPIHandlerResourceImpl
		implements JiraAPIHandlerResource {
		...
		public HttpInvoker.HttpResponse uploadJiraDocumentHttpResponse(
			...
			httpInvoker.part(
				"jiraAPIHandler", JiraAPIHandlerSerDes.toJSON(jiraAPIHandler));
		...
		private JiraAPIHandlerResourceImpl(Builder builder) {
			_builder = builder;
		}

		private static final Logger _logger = Logger.getLogger(
			JiraAPIHandlerResource.class.getName());
