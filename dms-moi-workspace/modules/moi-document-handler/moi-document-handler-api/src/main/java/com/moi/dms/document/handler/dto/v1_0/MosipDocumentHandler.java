package com.moi.dms.document.handler.dto.v1_0;
 ...
 */
@Generated("")
@GraphQLName("MosipDocumentHandler")
@JsonFilter("Liferay.Vulcan")
@XmlRootElement(name = "MosipDocumentHandler")
public class MosipDocumentHandler {

	public static MosipDocumentHandler toDTO(String json) {
		return ObjectMapperUtil.readValue(MosipDocumentHandler.class, json);
	}
	...
	@Schema(
		defaultValue = "com.moi.dms.document.handler.dto.v1_0.MosipDocumentHandler",
		name = "x-class-name"
	)
